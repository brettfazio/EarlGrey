...
Pod::Spec.new do |s|
  ...
  s.pod_target_xcconfig = { 'HEADER_SEARCH_PATHS' => '"${POD_ROOT}/EarlGreyTest/**" "${POD_ROOT}/eDistantObject/"', 'USER_HEADER_SEARCH_PATHS' => '"${POD_ROOT}/EarlGreyTest/**" "${POD_ROOT}/eDistantObject/"' }
